...
- **Example**:
    ...
    # Best fitness metrics are {'metrics/precision(B)': 0.87247, 'metrics/recall(B)': 0.71387, 'metrics/mAP50(B)': 0.79106, 'metrics/mAP50-95(B)': 0.62651, 'valid/box_loss': 2.79884, 'valid/cls_loss': 2.72386, 'valid/dfl_loss': 0.68503, 'fitness': 0.64297}
