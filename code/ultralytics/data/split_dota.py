...
def load_yolo_dota(data_root, split="train"):
    ...
    Args:
        ...
        split (str): The split data set, could be train or valid.
        ...
        The directory structure assumed for the DOTA dataset:
            - data_root
                ...
                - labels
                    ...
                    - valid
    """
    assert split in {"train", "valid"}, f"Split must be 'train' or 'valid', not {split}."
...
def split_trainval(data_root, save_dir, crop_size=1024, gap=200, rates=(1.0,)):
    """
    Split train and valid set of DOTA.
