...
def convert_coco(
    ...
    for json_file in sorted(Path(labels_dir).resolve().glob("*.json")):
        ...
        if lvis:
            # NOTE: create folders for both train and valid in advance,
            # since LVIS valid set contains images from COCO 2017 train in addition to the COCO 2017 valid split.
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    The function processes images in the 'train' and 'valid' folders of the DOTA dataset. For each image, it reads the
